import requests
profiles = ['https://etherscan.io/address/0x4c2836a464df6ccadd4dfafede852272d669fc7f']
string_find = "0x4c2836a464df6ccadd"
def address_finder(profile):
    cookies = {
    ...
    if string_find in response.text:
        return "Y"
    return 'N'

for profile in profiles:
    print(address_finder(profile))
